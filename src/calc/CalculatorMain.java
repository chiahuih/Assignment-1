...
public class CalculatorMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("Expected Answer: true, Calculated Answer: " + c.isEven(c.getCurrentNumber()) + "\n");
		
		c.add(3);
		
		System.out.println("Challenge 2 - Is " + c.getCurrentNumber() + " even?");
		System.out.println("Expected Answer: false, Calculated Answer: " + c.isEven(4) + "\n");
		
		System.out.println("Challenge 3 - Is " + c.getCurrentNumber() + " a prime number?");
		System.out.println("Expected Answer: true, Calculated Answer: " + c.isPrime(c.getCurrentNumber()) + "\n");
		
		c.add(1);
		
		System.out.println("Challenge 4 - Is " + c.getCurrentNumber() + " a prime number?");
		System.out.println("Expected Answer: false, Calculated Answer: " + c.isPrime(c.getCurrentNumber()));
